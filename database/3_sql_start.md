...
# 예제를 통한 SQL로 DB 정의하기
> IT회사 관련 RDB 만들기<br>
> 부서, 사원, 프로젝트 관련 정보들을 저장할 수 있는 관계형 데이터베이스<br>
> MySQL(InnoDB)를 사용함
...
### SCHEMA 정의
![table_schema](./images/3_1_table_schema.png)
### table 생성 쿼리
...
### 숫자
![attribute_data_type_number](./images/3_2_attribute_data_type_number.png)
<br>

### 문자열
![attribute_data_type_string](./images/3_3_attribute_data_type_string.png)
<br>

### 시간
![attribute_data_type_time](./images/3_4_attribute_data_type_time.png)
<br>

### 기타
![attribute_data_type_ect](./images/3_5_attribute_data_type_ect.png)
